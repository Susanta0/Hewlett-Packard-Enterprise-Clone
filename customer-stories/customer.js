...
//       customerCardContainer2.append(cardElement2);
...
// customerCardContainer.id = "customerCardContainer";
// const customerCardContainer2 = document.createElement("div");
// customerCardContainer2.id = "customerCardContainer2"; // Move this line outside the loop
// customerStoriesContainer.append(customerStoriesText, customerCardContainer);
...
//       customerCardContainer.append(cardElement);
//     } else {
//       customerCardContainer2.append(cardElement); // Append to the same container
//     }
//   });
// }

// // Append customerCardContainer2 outside the loop
// customerStoriesContainer.append(customerCardContainer2);
...
for (let i = 0; i < allCard.length; i++) {
  const customerCardContainerSet = document.createElement("div");
  customerCardContainerSet.className = "customerCardContainerSet";
  ...
  allCard[i].forEach((content, index) => {
    ...
    const videoLinkIcon = document.createElement("span");
    videoLinkIcon.className = "fa-solid fa-arrow-right";
    videoLinkIcon.id = "videoLinkIcon";
    videoLink.append(videoLinkIcon);

    textA.append(text1, text2, videoLink);

    customerCardContainerSet.append(cardElement);
  })
